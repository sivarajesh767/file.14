...
app.get('/movies/', async (request, response) => {
  ...
  response.send(movieArray.map(eachMovies => convertDbObjectToReverseDbObject(eachMovies)))
})
...
response.send(eachMovie=>convertDbObjectToReverseDbObject(eachMovie))
...
app.get('/directors/', async(request, response)=>{
  ...
  *
  ...
  response.send(directorArray.map(eachDirector => convertDbObjectToReverseDbObject(eachDirector)))
})
